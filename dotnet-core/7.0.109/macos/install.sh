...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/52a8870c-6644-4f27-bdfe-0637e498237a/a57a30b2f3340b74e25314ea1ab72e76/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
