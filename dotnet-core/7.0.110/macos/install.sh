...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/7026e6c5-976a-480f-815f-9d11df43a771/9d7b85249a6951703047b72c1d1bf483/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
