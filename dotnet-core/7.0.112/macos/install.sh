...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/0d472fb3-409e-4a0b-9dbe-c20e92b80a17/7b3b6689251aca4fa5053f49aa16b632/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
