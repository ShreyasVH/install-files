...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/47c386c4-5b7d-4c5d-b40e-aae04d34b973/0577d9079793e46cb90815d7872d3989/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
