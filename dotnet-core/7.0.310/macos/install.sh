...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/b223c2c9-1d4f-4840-a003-90d7eedc78b1/43f7b7c5edd862dda729a73f22ba8ece/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
