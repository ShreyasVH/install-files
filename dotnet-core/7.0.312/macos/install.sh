...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget -q --show-progress "https://download.visualstudio.microsoft.com/download/pr/35405023-7383-45d1-87bd-3f60dacac5f3/65a9b2a9f9cc2da877b6817725010930/dotnet-sdk-$VERSION-osx-arm64.tar.gz"
	mkdir $VERSION
