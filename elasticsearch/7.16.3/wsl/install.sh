...
if [ ! -e $HOME/workspace/myProjects/config-samples/$FOLDER_NAME/$VERSION/wsl/elasticsearch.yml ]; then
...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/elasticsearch" ]; then
	...
	touch stop.sh
	mv config/elasticsearch.yml ~/workspace/myProjects/config-samples/$FOLDER_NAME/$VERSION/wsl/elasticsearch.yml.default
	ln -s ~/workspace/myProjects/config-samples/$FOLDER_NAME/$VERSION/wsl/elasticsearch.yml config/elasticsearch.yml
