...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/lib/pkgconfig/libfastjson.pc" ]; then
	...
	wget -q --show-progress "https://github.com/rsyslog/libfastjson/archive/refs/tags/$ARCHIVE_FILE"
	...
	autoreconf -fi > $HOME/logs/$FOLDER_NAME/$VERSION/autoreconfOutput.txt 2>&1
