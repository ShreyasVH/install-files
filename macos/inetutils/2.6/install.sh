...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/telnet" ]; then
	...
	./configure --prefix=$HOME/programs/$FOLDER_NAME/$VERSION --disable-servers > $HOME/logs/$FOLDER_NAME/$VERSION/configureOutput.txt 2>&1
