...
if [ ! -e "$HOME/programs/$POSTGRES_FOLDER_NAME/$POSTGRES_VERSION/lib/postgis-3.dylib" ]; then
	...
	if [ -e "$HOME/programs/$POSTGRES_FOLDER_NAME/$POSTGRES_VERSION/lib/postgis-3.dylib" ]; then
		...
		install_name_tool -change @rpath/libgeos.3.11.0.dylib $HOME/programs/$GEOS_FOLDER_NAME/$GEOS_VERSION/lib/libgeos.3.11.0.dylib $HOME/programs/$GEOS_FOLDER_NAME/$GEOS_VERSION/lib/libgeos_c.1.17.0.dylib
