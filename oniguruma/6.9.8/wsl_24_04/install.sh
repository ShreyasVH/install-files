...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/onig-config" ]; then
	...
	bash $INSTALL_FILES_DIR/$AUTOMAKE_FOLDER_NAME/$AUTOMAKE_VERSION/wsl_24_04/install.sh
	bash $INSTALL_FILES_DIR/$LIBTOOL_FOLDER_NAME/$LIBTOOL_VERSION/wsl_24_04/install.sh
