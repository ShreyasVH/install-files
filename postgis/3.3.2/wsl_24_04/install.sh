...
if [ ! -e "$HOME/programs/$POSTGRES_FOLDER_NAME/$POSTGRES_VERSION/lib/postgis-3.so" ]; then
	...
	bash $INSTALL_FILES_DIR/$GEOS_FOLDER_NAME/$GEOS_VERSION/wsl_24_04/install.sh
	bash $INSTALL_FILES_DIR/$PROJ_FOLDER_NAME/$PROJ_VERSION/wsl_24_04/install.sh
	...
	bash $INSTALL_FILES_DIR/$LIBTIFF_FOLDER_NAME/$LIBTIFF_VERSION/wsl_24_04/install.sh
