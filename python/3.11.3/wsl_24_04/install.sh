...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/python3" ]; then
	...
	bash $INSTALL_FILES_DIR/$GETTEXT_FOLDER_NAME/$GETTEXT_VERSION/wsl_24_04/install.sh
	...
	bash $INSTALL_FILES_DIR/$LIBFFI_FOLDER_NAME/$LIBFFI_VERSION/wsl_24_04/install.sh
