...
if [ ! -d "$HOME/programs/$FOLDER_NAME/$VERSION" ]; then
	...
	wget --show-progress "https://archive.apache.org/dist/maven/maven-$MAJOR_VERSION/$VERSION/binaries/$ARCHIVE_FILE" > $HOME/logs/$FOLDER_NAME/$VERSION/download.txt 2>&1
