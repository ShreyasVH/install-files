...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/java" ]; then
	...
	ARCHIVE_FILE="bellsoft-jdk$VERSION+10-linux-amd64.tar.gz"
	wget --show-progress "https://github.com/bell-sw/Liberica/releases/download/$VERSION+10/$ARCHIVE_FILE" > $HOME/logs/$FOLDER_NAME/$VERSION/download.txt 2>&1
