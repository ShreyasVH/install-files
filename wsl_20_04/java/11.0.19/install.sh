...
if [ ! -e "$HOME/programs/$FOLDER_NAME/$VERSION/bin/java" ]; then
	...
	ARCHIVE_FILE=openlogic-openjdk-jre-$VERSION+7-linux-x64.tar.gz
	wget -q "https://builds.openlogic.com/downloadJDK/openlogic-openjdk-jre/$VERSION+7/$ARCHIVE_FILE"
